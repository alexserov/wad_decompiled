...
namespace UIAutomationClient
{
  ...
  public interface IUIAutomationElement3 : IUIAutomationElement2
  {
    ...
    [DispId(1610809345)]
    int CurrentIsPeripheral { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

    [DispId(1610809346)]
    int CachedIsPeripheral { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
  }
}
