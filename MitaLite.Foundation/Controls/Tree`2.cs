...
namespace MS.Internal.Mita.Foundation.Controls
{
    ...
    where I : TreeItem<C, I>
  {
    ...
    private static readonly UICondition _treeCondition = UICondition.Create("@ControlType=Tree Or @ControlType=TreeItem");
    ...
    public virtual UICollection<I> Items => (UICollection<I>) new UIChildren<I>((UIObject) this, Tree<C, I>.TreeCondition, this._itemFactory);
    ...
    protected static UICondition TreeCondition => Tree<C, I>._treeCondition;
  }
}
