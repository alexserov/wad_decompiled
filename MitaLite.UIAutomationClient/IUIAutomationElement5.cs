...
namespace UIAutomationClient {
    [Guid(guid: "98141C1D-0D0E-4175-BBE2-6BFF455842A7"), InterfaceType(interfaceType: ComInterfaceType.InterfaceIsDual), ComImport]
    public interface IUIAutomationElement5 : IUIAutomationElement4 {
        ...
        [DispId(dispId: 1610940416)]
        int CurrentLandmarkType {
            [MethodImpl(methodImplOptions: MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
            get;
        }

        [DispId(dispId: 1610940417)]
        string CurrentLocalizedLandmarkType {
            [MethodImpl(methodImplOptions: MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(unmanagedType: UnmanagedType.BStr)]
            get;
        }

        [DispId(dispId: 1610940418)]
        int CachedLandmarkType {
            [MethodImpl(methodImplOptions: MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
            get;
        }

        [DispId(dispId: 1610940419)]
