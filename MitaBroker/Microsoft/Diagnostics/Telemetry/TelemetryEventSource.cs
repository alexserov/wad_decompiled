...
namespace Microsoft.Diagnostics.Telemetry
{
  internal class TelemetryEventSource : EventSource
  {
    ...
    private static readonly string[] microsoftTelemetryTraits = new string[2]
    {
      "ETW_GROUP",
      "{4f50731a-89cf-4782-b3e0-dce8c90476ba}"
    };
    private static readonly string[] windowsCoreTelemetryTraits = new string[2]
    {
      "ETW_GROUP",
    ...
    public TelemetryEventSource(string eventSourceName)
      : base(eventSourceName, EventSourceSettings.EtwSelfDescribingEventFormat, TelemetryEventSource.microsoftTelemetryTraits)
    {
    }

    protected TelemetryEventSource()
      : base(EventSourceSettings.EtwSelfDescribingEventFormat, TelemetryEventSource.microsoftTelemetryTraits)
    {
    }

    public TelemetryEventSource(string eventSourceName, TelemetryGroup telemetryGroup)
      : base(eventSourceName, EventSourceSettings.EtwSelfDescribingEventFormat, telemetryGroup == TelemetryGroup.WindowsCoreTelemetry ? TelemetryEventSource.windowsCoreTelemetryTraits : TelemetryEventSource.microsoftTelemetryTraits)
    {
    }
