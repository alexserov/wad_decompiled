...
namespace MS.Internal.Mita.Foundation.Waiters {
    public class ToolTipOpenedWaiter : UIEventWaiter {
        ...
        public ToolTipOpenedWaiter(UIObject rootElement, Scope scope, UICondition condition)
            : base(eventSource: new AutomationEventSource(eventId: AutomationElement.ToolTipOpenedEvent, root: rootElement, scope: scope)) {
        ...
        public override string ToString() {
            return "ToolTipOpenedWaiter with Condition:  " + this._condition;
        }
    }
}